...
if /%1==/shared (
	...
	rem set glogFlagCudaOrig="/UGOOGLE_GLOG_DLL_DECL /UGOOGLE_GLOG_DLL_DECL_FOR_UNITTESTS"
	...
	rem set glogFlagCudaOrig=""
	set protoBufFlagOrig=""
)
set glogFlag=%glogFlagOrig:"=%
rem set glogFlagCuda=%glogFlagCudaOrig:"=%
...
-DBLAS="Open" ^
-Dpython_version="3" ^
-DCMAKE_CXX_FLAGS="/DWIN32 /D_WINDOWS /W3 /GR /EHa /DHAVE_LAPACK_CONFIG_H /DLAPACK_COMPLEX_CPP /wd4505 /wd4819 %glogFlag% %protoBufFlag% /bigobj" ^
-DCMAKE_C_FLAGS="/DWIN32 /D_WINDOWS /W3 /DHAVE_LAPACK_CONFIG_H /DLAPACK_COMPLEX_STRUCTURE /wd4505 /wd4819 %glogFlag% %protoBufFlag% /bigobj" ^
