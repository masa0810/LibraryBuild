...
if (${HDF5_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF5_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/lib/x64/jarhdf5-1.10.1.jar
      ${PACKAGE_PREFIX_DIR}/lib/slf4j-api-1.7.5.jar
      ${PACKAGE_PREFIX_DIR}/lib/slf4j-nop-1.7.5.jar
  )
  set (${HDF5_PACKAGE_NAME}_JAVA_LIBRARY "${PACKAGE_PREFIX_DIR}/lib/x64")
...
if (${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
  ...
  set_and_check (${HDF5_PACKAGE_NAME}_TOOLS_DIR "${PACKAGE_PREFIX_DIR}/bin/x64")
endif ()
...
if (NOT TARGET "hdf5")
  ...
  if(BUILD_SHARED_LIBS)
    include (${CMAKE_CURRENT_LIST_DIR}/lib/hdf5-targets.cmake)
  else()
    include (${CMAKE_CURRENT_LIST_DIR}/staticlib/hdf5-targets.cmake)
  endif()
endif ()
